  ...
  return (
    <main style={pageStyle}>
      <section style={heroStyle}>
        <p style={badgeStyle}>FLEET MANAGEMENT</p>
        <h1 style={titleStyle}>My Registered Vehicles</h1>
        <p style={descStyle}>
          View vehicles registered for cargo transport, delivery services,
          passenger movement, and logistics operations.
        </p>
      ...
      <section style={containerStyle}>
        <div style={sectionHeaderStyle}>
          <p style={sectionBadgeStyle}>LIVE VEHICLE DATABASE</p>
          <h2 style={sectionTitleStyle}>Registered Vehicles</h2>
          <p style={sectionTextStyle}>
            Vehicles submitted through the registration form now appear here
            ...
            {vehicles.map((vehicle) => (
              <article key={vehicle.id} style={cardStyle}>
                ...
                <div style={cardActionsStyle}>
                  ...
                  <Link href="/admin/vehicle-approvals" style={lightButtonStyle}>
                    Approval
                  </Link>
                </div>
              </article>
