...
type Supplier = { id: string; name: string; contact_name: string; email: string; phone: string; category: string; };
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div><h1 className="text-3xl font-bold">Suppliers</h1><p className="text-gray-500">Manage your suppliers.</p></div>
