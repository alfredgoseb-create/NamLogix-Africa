  ...
  async function handleSave(e: React.FormEvent) {
    ...
    if (editingId) {
      const { error } = await supabase
        .from("suppliers").update(form).eq("id", editingId);
      if (error) alert("Error: " + error.message);
    } else {
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-8">
          ...
          <form onSubmit={handleSave} className="grid md:grid-cols-2 gap-4">
            ...
            <input type="text" placeholder="Category (e.g. Electronics)"
              value={form.category}
            ...
            <div className="col-span-2 flex gap-3">
              ...
              {editingId && (
                <button type="button"
                  onClick={() => { setEditingId(null); setForm({ name: "", contact_name: "", email: "", phone: "", category: "" }); }}
        ...
        <div className="bg-white rounded-xl shadow p-6">
          ...
          {loading ? (
            ...
            <p className="text-gray-400">No suppliers yet. Add one above.</p>
          ) : (
              ...
              {suppliers.map((s) => (
                <div key={s.id}
                  ...
                  <div>
                    ...
                    {s.category && (
                      <span className="text-xs bg-blue-50 text-blue-600 px-2 py-1 rounded-full mt-1 inline-block">
                        {s.category}
                      </span>
                    )}
                  </div>
